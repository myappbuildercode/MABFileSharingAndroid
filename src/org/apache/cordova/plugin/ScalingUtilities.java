...
public class ScalingUtilities {
	...
	static Bitmap unscaledBitmap = null;
	public static Bitmap decodeFile(Bitmap path, int dstWidth, int dstHeight,
	...
	public static Bitmap createScaledBitmap(Bitmap unscaledBitmap,
		...
		Bitmap scaledBitmap = Bitmap.createBitmap(dstRect.width(),
				dstRect.height(), Config.ARGB_4444);
...
//http://stackoverflow.com/questions/13116634/android-customize-photo-size
//
